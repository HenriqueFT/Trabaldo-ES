...
public class FinalizarExcursao extends javax.swing.JFrame {

    /**
     * Creates new form FinalizarExcursao
     */
    public FinalizarExcursao() {
        initComponents();
    }       
    /**
    ...
    private void finalizarBottonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_finalizarBottonActionPerformed
        ...
        try {
            ...
            if (horaChegada > horaEsperada){
               MotivoAtraso m = new MotivoAtraso();
               m.setVis();
            }
            
        } catch (Exception ex) {
            Logger.getLogger(FinalizarExcursao.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FinalizarExcursao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FinalizarExcursao().setVisible(true);
            }
        });
    }
